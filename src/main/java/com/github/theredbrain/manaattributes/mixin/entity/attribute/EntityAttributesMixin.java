...
public class EntityAttributesMixin {
	static {
		...
		ManaAttributes.MAX_MANA = Registry.registerReference(Registries.ATTRIBUTE, ManaAttributes.identifier("generic.max_mana"), new ClampedEntityAttribute("attribute.name.generic.max_mana", 10.0, 0.0, 1024.0).setTracked(true));
