...
public class EntityAttributesMixin {
    ...
    static {
        ...
        ManaAttributes.MANA_REGENERATION_DELAY_THRESHOLD = register(ManaAttributes.MOD_ID + ":generic.mana_regeneration_delay_threshold", new ClampedEntityAttribute("attribute.name.generic.mana_regeneration_delay_threshold", 60.0, 0.0, 1024.0).setTracked(true));
